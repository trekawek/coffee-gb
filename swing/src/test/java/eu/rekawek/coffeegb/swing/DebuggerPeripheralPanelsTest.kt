...
class DebuggerPeripheralPanelsTest {
  ...
  fun `graphics panel renders copyable accessible tables then releases all rendered state`() {
    ...
    onEdt {
      ...
      assertEquals("\$9800", panel.windowMapDetails.mapAddressValue.text)
      assertContains(panel.windowMapDetails.tileValue.text, "\$03")
      ...
      assertEquals("Row 0, column 1", panel.windowMapDetails.mapCellValue.text)
      assertContains(panel.windowMapDetails.copyText(), "Map address")
