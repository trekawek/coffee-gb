...
| --- | --- | --- | --- |
| **Execution** | Run/reverse toolbar; register cells and flags; current instruction; execution state; stack; stop and history status | Scalars and safe PC/SP blocks at up to 20 Hz; immediate request after commands; Hold withdraws this window's interest | Multi-line banked disassembly, symbols, watches, and call stack need richer models |
