...
1. The owning controller/emulator thread at a frame boundary, after queued topology/input events
   ...
   event/protocol-owned P1 held buttons. Local SGB P1-P4 physical input stays in the live service.
