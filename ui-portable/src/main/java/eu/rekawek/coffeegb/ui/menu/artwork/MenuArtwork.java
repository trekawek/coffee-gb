 ...
 * provenance and test-fixture metadata. Runtime composition starts from the 924x736 frame returned
 * by {@link #templateFilename()}. Platform adapters consume the resulting ARGB pixels and map
 * input through {@link MenuViewport}.
 */
public final class MenuArtwork {
    ...
    /** Returns the text-free frame used to compose this route's layout. */
    public String templateFilename() {
        return route == MenuRoute.FILE_BROWSER
