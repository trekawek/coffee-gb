...
public class AluFunctions implements Serializable {
  ...
  private void registerAluFunction(
      String name, DataType dataType1, DataType dataType2, BiIntRegistryFunction function) {
...

  {
    ...
    registerAluFunction(
        "ADD", DataType.D16, DataType.R8, (flags, arg1, arg2) -> (arg1 + arg2) & 0xffff);
    registerAluFunction(
        "ADD_SP",
        DataType.D16,
        DataType.R8,
    ...
    registerAluFunction(
        "RES", DataType.D8, DataType.D8, (flags, arg1, arg2) -> BitUtils.clearBit(arg1, arg2));
    registerAluFunction(
