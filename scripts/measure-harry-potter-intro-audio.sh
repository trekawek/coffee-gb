...
PROBE_PATH="core/src/test/java/eu/rekawek/coffeegb/core/performance/HarryPotterIntroAudioTest.java"
SUPPORT_PATH="core/src/test/java/eu/rekawek/coffeegb/core/performance/HarryPotterIntroHarness.java"
HARNESS_FILE="${HARRY_POTTER_AUDIO_HARNESS:-}"
...
report="core/target/surefire-reports/TEST-eu.rekawek.coffeegb.core.performance.HarryPotterIntroAudioTest.xml"
