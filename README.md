...
| [Gambatte HWTests](https://github.com/pokemon-speedrunning/gambatte-core/tree/master/test) | 4,674 | 4,442 match hardware; 232 current outputs are pinned exactly |
...
output. Gambatte's 232 unresolved cases are likewise pinned to their complete
