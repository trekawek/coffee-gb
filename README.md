...
| [Gambatte HWTests](https://github.com/pokemon-speedrunning/gambatte-core/tree/master/test) | 4,674 | 4,374 match hardware; 300 current outputs are pinned exactly |
...
output. Gambatte's 300 unresolved cases are likewise pinned to their complete
