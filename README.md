...
| [Gambatte HWTests](https://github.com/pokemon-speedrunning/gambatte-core/tree/master/test) | 4,674 | 4,389 match hardware; 285 current outputs are pinned exactly |
...
output. Gambatte's 285 unresolved cases are likewise pinned to their complete
