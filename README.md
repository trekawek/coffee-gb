...
| [Gambatte HWTests](https://github.com/pokemon-speedrunning/gambatte-core/tree/master/test) | 4,674 | 4,458 match hardware; 216 current outputs are pinned exactly |
...
output. Gambatte's 216 unresolved cases are likewise pinned to their complete
