...
| [Gambatte HWTests](https://github.com/pokemon-speedrunning/gambatte-core/tree/master/test) | 4,674 | 4,341 match hardware; 333 current outputs are pinned exactly |
...
output. Gambatte's 333 unresolved cases are likewise pinned to their complete
