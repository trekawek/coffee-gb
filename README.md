...
| [Gambatte HWTests](https://github.com/pokemon-speedrunning/gambatte-core/tree/master/test) | 4,674 | 4,325 match hardware; 349 current outputs are pinned exactly |
...
output. Gambatte's 349 unresolved cases are likewise pinned to their complete
