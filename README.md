...
| [Gambatte HWTests](https://github.com/pokemon-speedrunning/gambatte-core/tree/master/test) | 4,674 | 4,470 match hardware; 204 current outputs are pinned exactly |
...
output. Gambatte's 204 unresolved cases are likewise pinned to their complete
