...
public class HarryPotterIntroAudioDiscoveryTest {
    ...
    private static final String DEFAULT_ROM = "Z:\\emu\\roms\\gbc\\H\\Harry Potter and the Sorcerer's Stone (USA, Europe) (En,Fr,De,Es,It,Nl,Pt,Sv,No,Da,Fi).gbc";
    ...
    public void scanAudioActivity() throws Exception {
        File rom = new File(System.getProperty("harryPotterRom", DEFAULT_ROM));
        if (!rom.isFile()) {
