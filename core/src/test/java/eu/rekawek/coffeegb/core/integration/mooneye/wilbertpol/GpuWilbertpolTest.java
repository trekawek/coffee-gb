...
public class GpuWilbertpolTest {

    private final Path romPath;

    @Parameterized.Parameters(name = "{0}")
    public static Collection<Object[]> data() throws IOException {
        return ParametersProvider.getParameters("mooneye-wilbertpol/acceptance/gpu");
    }

    public GpuWilbertpolTest(String name, Path romPath) {
